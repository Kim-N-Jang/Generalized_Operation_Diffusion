...
def arg_parser():
  ...
  parser.add_argument('--training_split', type=str, default='data/tsp/tsp200_train_concorde.txt')
  ...
  parser.add_argument('--validation_split', type=str, default='data/tsp/tsp200_test_concorde.txt')
  parser.add_argument('--test_split', type=str, default='data/tsp/tsp200_test_concorde.txt')
